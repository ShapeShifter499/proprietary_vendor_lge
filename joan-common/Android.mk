...
include $(CLEAR_VARS)
LOCAL_MODULE := GBAService
LOCAL_MODULE_OWNER := lge
LOCAL_SRC_FILES := proprietary/product/priv-app/GBAService/GBAService.apk
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := APPS
LOCAL_DEX_PREOPT := false
...
LOCAL_MODULE := LGIms
LOCAL_MODULE_OWNER := lge
LOCAL_SRC_FILES := proprietary/product/priv-app/LGIms/LGIms.apk
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := APPS
LOCAL_DEX_PREOPT := false
...
include $(CLEAR_VARS)
LOCAL_MODULE := lg-framework
LOCAL_MODULE_OWNER := lge
LOCAL_SRC_FILES := proprietary/framework/lg-framework.jar
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := JAVA_LIBRARIES
LOCAL_MODULE_SUFFIX := .jar
